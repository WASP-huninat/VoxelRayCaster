...
namespace Renderer
{
    internal class Render : Program
    {
        ...
        internal static unsafe void Window_Render(double obj)
        {
            ...
            for (uint i = 0; i < color.Length; i += 4)
            {
                indexList.AddRange([i, i + 1, i + 2, i + 1, i + 2, i + 3]);
            };
            ...
            _gL.BufferData(GLEnum.ElementArrayBuffer, (ReadOnlySpan<uint>)indexList.ToArray().AsSpan(), GLEnum.StaticDraw);

            _gL.BindBuffer(GLEnum.ArrayBuffer, 0);
            _gL.UseProgram(_program);
            _gL.DrawElements(GLEnum.Triangles, (uint)indexList.Count, GLEnum.UnsignedInt, null);
